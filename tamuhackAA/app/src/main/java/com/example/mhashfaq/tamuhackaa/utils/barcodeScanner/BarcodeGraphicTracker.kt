 ...
 */
package com.sympliact.utils.barcodeScanner
 ...
 * goes away.
 */
internal class BarcodeGraphicTracker(mOverlay: GraphicOverlay<BarcodeGraphic>?, mGraphic: BarcodeGraphic, mContext: Context) : Tracker<Barcode>() {


    private var mOverlay: GraphicOverlay<BarcodeGraphic>?
    ...
    init {
        ...
        if (mContext is BarcodeUpdateListener) {
            this.mBarcodeUpdateListener = mContext as BarcodeUpdateListener
        } else {
