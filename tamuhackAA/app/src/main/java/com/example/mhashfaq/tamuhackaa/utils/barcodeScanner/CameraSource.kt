...
private constructor() {
    ...
    private fun createCamera(): Camera {
        ...
        camera.addCallbackBuffer(createPreviewBuffer(previewSize as Size))
        camera.addCallbackBuffer(createPreviewBuffer(previewSize as Size))
        camera.addCallbackBuffer(createPreviewBuffer(previewSize as Size))
        camera.addCallbackBuffer(createPreviewBuffer(previewSize as Size))
    ...
    private class SizePair(previewSize: android.hardware.Camera.Size,
        ...
        private var mPreview: Size = Size(previewSize.width, previewSize.height)
